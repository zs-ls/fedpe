...
class_dir = os.path.join(parent_path, 'dataset', 'FEMINIST', 'raw', 'by_class')
rel_class_dir = os.path.join('dataset', 'FEMINIST', 'raw', 'by_class')
...
write_dir = os.path.join(parent_path, 'dataset', 'FEMINIST', 'raw', 'by_write')
rel_write_dir = os.path.join('dataset', 'FEMINIST', 'raw', 'by_write')
...
util.save_obj(
    class_files,
    os.path.join(parent_path, 'dataset', 'FEMINIST', 'intermediate', 'class_file_dirs'))
util.save_obj(
    write_files,
    os.path.join(parent_path, 'dataset', 'FEMINIST', 'intermediate', 'write_file_dirs'))
