...
by_writer_dir = os.path.join(parent_path, 'dataset', 'FEMINIST', 'intermediate', 'images_by_writer')
...
for (w, l) in writers:
    ...
    if writer_count == MAX_WRITERS or all_writers == len(writers):
        ...
        file_path = os.path.join(parent_path, 'dataset', 'FEMINIST', 'all_data', file_name)
